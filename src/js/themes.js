...
export class DarkTheme extends Theme {
    ...
    constructor() {
        ...
        if (Kline.instance.reverseColor) {
            this._colors[Theme.Color.Positive] = "#eb1944";
            this._colors[Theme.Color.Negative] = "#43cc63";
            this._colors[Theme.Color.PositiveDark] = "#3b0e08";
            this._colors[Theme.Color.NegativeDark] = "#004718";
        } else {
            this._colors[Theme.Color.Positive] = "#43cc63";
            this._colors[Theme.Color.Negative] = "#eb1944";
        ...
        this._colors[Theme.Color.Background] = "#333537";
